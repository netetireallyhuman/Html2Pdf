...
namespace H2P
{
    internal class Program
    {
        ...
        private static void Syntax(string message)
        {
            ...
            fullMessage.AppendLine("\t         -p:page-settings(comma-separated)");
            fullMessage.AppendLine("\t         page-settings: ");
            fullMessage.AppendLine("\t\t\tA4: Din-A4 portrait (default).");
            fullMessage.AppendLine("\t\t\tl or landscape: Din-A4 landscape.");
            ...
            fullMessage.AppendLine("\t\t\tpr or pageRanges=\"optional: e.g. 1 or 2-4\"");
